...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold text-dark mb-0">Edit Voucher</h3>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ route('mitra.voucher.update', $voucher->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_voucher') is-invalid @enderror" name="nama_voucher" value="{{ old('nama_voucher', $voucher->nama_voucher) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control text-uppercase @error('kode_voucher') is-invalid @enderror" name="kode_voucher" value="{{ old('kode_voucher', $voucher->kode_voucher) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('tipe_potongan') is-invalid @enderror" name="tipe_potongan" id="tipe_potongan" required>
                        <option value="persentase" {{ old('tipe_potongan', $voucher->tipe_potongan) == 'persentase' ? 'selected' : '' }}>Persentase (%)</option>
                        <option value="nominal" {{ old('tipe_potongan', $voucher->tipe_potongan) == 'nominal' ? 'selected' : '' }}>Nominal (Rp)</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('nilai_potongan') is-invalid @enderror" name="nilai_potongan" value="{{ old('nilai_potongan', (int)$voucher->nilai_potongan) }}" min="0" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('alokasi') is-invalid @enderror" name="alokasi" id="alokasi" required>
                        <option value="semua_menu" {{ old('alokasi', $voucher->alokasi) == 'semua_menu' ? 'selected' : '' }}>Seluruh Menu</option>
                        <option value="menu_tertentu" {{ old('alokasi', $voucher->alokasi) == 'menu_tertentu' ? 'selected' : '' }}>Menu Tertentu</option>
                    </select>
                ...
                <div class="col-md-6 mb-3" id="produk_container" style="display: none;">
                    ...
                    <select class="form-select @error('produk_id') is-invalid @enderror" name="produk_id">
                        ...
                        @foreach($produks as $produk)
                            <option value="{{ $produk->produk_id }}" {{ old('produk_id', $voucher->produk_id) == $produk->produk_id ? 'selected' : '' }}>{{ $produk->nama_produk }} (Stok: {{ $produk->stok_tersisa }})</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('minimal_belanja') is-invalid @enderror" name="minimal_belanja" value="{{ old('minimal_belanja', $voucher->minimal_belanja) }}" min="0" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('kuota') is-invalid @enderror" name="kuota" value="{{ old('kuota', $voucher->kuota) }}" min="0" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="datetime-local" class="form-control @error('tanggal_mulai') is-invalid @enderror" name="tanggal_mulai" value="{{ old('tanggal_mulai', date('Y-m-d\TH:i', strtotime($voucher->tanggal_mulai))) }}" required>
                    @error('tanggal_mulai')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Tanggal Kadaluarsa (Expired)</label>
                    <input type="datetime-local" class="form-control @error('tanggal_selesai') is-invalid @enderror" name="tanggal_selesai" value="{{ old('tanggal_selesai', date('Y-m-d\TH:i', strtotime($voucher->tanggal_selesai))) }}" required>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="statusAktif" value="aktif" {{ old('status', $voucher->status) == 'aktif' ? 'checked' : '' }}>
                            <label class="form-check-label text-success fw-bold" for="statusAktif">Aktif</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="statusNonaktif" value="nonaktif" {{ old('status', $voucher->status) == 'nonaktif' ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-2 border-top pt-4">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="fas fa-save me-2"></i> Update Voucher</button>
            </div>
        </form>
    </div>
</div>
