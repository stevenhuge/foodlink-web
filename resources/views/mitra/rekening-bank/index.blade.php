...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="h3 mb-0 text-gray-800">Kelola Rekening Bank</h2>
        <a href="{{ route('mitra.pemasukan.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="row">
        <div class="col-lg-5">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('mitra.rekening-bank.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                                ...
                                @forelse ($rekeningBank as $rekening)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            <form action="{{ route('mitra.rekening-bank.destroy', $rekening->rekening_id) }}" method="POST" class="d-inline"
    ...
    <div class="modal fade" id="editModal-{{ $rekening->rekening_id }}" tabindex="-1" aria-labelledby="editModalLabel-{{ $rekening->rekening_id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('mitra.rekening-bank.update', $rekening->rekening_id) }}" method="POST">
                    @csrf
                    @method('PUT')
