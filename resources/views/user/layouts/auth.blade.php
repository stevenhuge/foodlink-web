    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-sidebar d-none d-lg-flex">
            ...
            <div class="sidebar-content glass-panel">
                <div class="mb-4">
                    <span class="badge bg-white text-success rounded-pill px-3 py-2 fw-semibold">FoodLink untuk Semua</span>
                </div>
                <h2 class="display-6 fw-bold mb-4">Bergabunglah dalam Gerakan Kami</h2>
                <p class="fs-5 opacity-75 mb-0">
                    Jadilah bagian dari komunitas yang peduli. Dapatkan makanan berkualitas dengan harga murah sambil membantu mengurangi food waste.
                </p>
                ...
                <div class="d-flex gap-3 mt-5">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-check-circle fs-5"></i>
                        <span class="small fw-medium">Makanan Berkualitas</span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <i class="fas fa-check-circle fs-5"></i>
        ...
        <div class="auth-main">
            <div class="auth-container">
                ...
                <div class="auth-header text-start d-none d-lg-block">
                    <h1 class="h2 fw-bold mb-2">Portal Pengguna</h1>
                    <p class="text-muted">Buat akun untuk mendapatkan penawaran terbaik setiap hari.</p>
                </div>
