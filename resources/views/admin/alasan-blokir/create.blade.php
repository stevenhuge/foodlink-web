{{-- resources/views/admin/alasan-blokir/create.blade.php --}}
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="h3 mb-0 text-gray-800">Tambah Alasan Blokir Baru</h2>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <form action="{{ route('admin.alasan-blokir.store') }}" method="POST">
                    ...
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-dark">Detail Alasan</h5>
                    </div>
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-1"></i> Simpan Alasan
                        </button>
