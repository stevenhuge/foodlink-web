...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="h3 mb-0 text-gray-800">Edit Kategori Usaha</h2>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <form action="{{ route('admin.kategori-usaha.update', $kategoriUsaha->kategori_usaha_id) }}" method="POST">
                    ...
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-dark">Edit: {{ $kategoriUsaha->nama_kategori }}</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('nama_kategori', $kategoriUsaha->nama_kategori) }}"
                                   required
                                   autofocus>
